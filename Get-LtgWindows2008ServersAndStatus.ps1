Get-ADComputer -SearchBase "DC=lansing,DC=local" -Server "ltgdc03.lansing.local" -Filter {OperatingSystem -Like "Windows Server 200*"} -Property * | ForEach-Object `
    {
    ...
    } | Export-Csv "C:\Users\mw148186\OneDrive - The Andersons, Inc\OUTPUT_Get-LtgWindows2008ServersAndStatus.csv" -NoTypeInformation